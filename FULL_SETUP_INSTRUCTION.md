...
Do not publish these files publicly:
- `.env`
- `data/applications.db`
- any archive that contains a real token or real user data

## 22. GitHub upload recommendation
Before uploading the project to GitHub, make sure that the following are not included:
- `venv/`
- `.env`
- `data/`
- `__pycache__/`
...
The `.gitignore` file in this project already excludes them.
